...
export namespace payment {
  ...
  export class MonthOverviewDTO {
    ...
    constructor(source: any = {}) {
      ...
      this.subscriptionCoursesTracked = source["subscriptionCoursesTracked"];
      this.subscriptionFilled = source["subscriptionFilled"];
      this.subscriptionMissing = source["subscriptionMissing"];
      this.monthControlTotal = source["monthControlTotal"];
      this.monthControlFilled = source["monthControlFilled"];
      this.monthControlMissing = source["monthControlMissing"];
