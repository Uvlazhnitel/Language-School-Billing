...
func (_q *AuditLogQuery) QueryActorUser() *UserQuery {
...
func (_q *AuditLogQuery) WithActorUser(opts ...func(*UserQuery)) *AuditLogQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *AuditLogQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*AuditLog, error) {
	...
	if query := _q.withActorUser; query != nil {
		if err := _q.loadActorUser(ctx, query, nodes, nil,
			func(n *AuditLog, e *User) { n.Edges.ActorUser = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *AuditLogQuery) loadActorUser(ctx context.Context, query *UserQuery, nodes []*AuditLog, init func(*AuditLog), assign func(*AuditLog, *User)) error {
