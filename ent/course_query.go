...
func (_q *CourseQuery) QueryTeacher() *TeacherQuery {
...
func (_q *CourseQuery) WithTeacher(opts ...func(*TeacherQuery)) *CourseQuery {
	query := (&TeacherClient{config: _q.config}).Query()
...
func (_q *CourseQuery) loadTeacher(ctx context.Context, query *TeacherQuery, nodes []*Course, init func(*Course), assign func(*Course, *Teacher)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*Course)
	for i := range nodes {
		if nodes[i].TeacherID == nil {
			continue
		}
