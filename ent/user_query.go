...
func (_q *UserQuery) QuerySessions() *WebSessionQuery {
	query := (&WebSessionClient{config: _q.config}).Query()
...
func (_q *UserQuery) WithSessions(opts ...func(*WebSessionQuery)) *UserQuery {
	query := (&WebSessionClient{config: _q.config}).Query()
...
func (_q *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := _q.withSessions; query != nil {
		if err := _q.loadSessions(ctx, query, nodes,
			func(n *User) { n.Edges.Sessions = []*WebSession{} },
			func(n *User, e *WebSession) { n.Edges.Sessions = append(n.Edges.Sessions, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *UserQuery) loadSessions(ctx context.Context, query *WebSessionQuery, nodes []*User, init func(*User), assign func(*User, *WebSession)) error {
	...
	query.withFKs = true
	query.Where(predicate.WebSession(func(s *sql.Selector) {
