...
func (_q *EnrollmentQuery) QueryStudent() *StudentQuery {
...
func (_q *EnrollmentQuery) WithStudent(opts ...func(*StudentQuery)) *EnrollmentQuery {
	query := (&StudentClient{config: _q.config}).Query()
...
func (_q *EnrollmentQuery) loadStudent(ctx context.Context, query *StudentQuery, nodes []*Enrollment, init func(*Enrollment), assign func(*Enrollment, *Student)) error {
...
func (_q *EnrollmentQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withStudent != nil {
			_spec.Node.AddColumnOnce(enrollment.FieldStudentID)
		}
