...
// AddSessions adds the "sessions" edges to the WebSession entity.
func (_u *UserUpdate) AddSessions(v ...*WebSession) *UserUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearSessions clears all "sessions" edges to the WebSession entity.
func (_u *UserUpdate) ClearSessions() *UserUpdate {
	_u.mutation.ClearSessions()
	return _u
}

// RemoveSessionIDs removes the "sessions" edge to WebSession entities by IDs.
func (_u *UserUpdate) RemoveSessionIDs(ids ...int) *UserUpdate {
	_u.mutation.RemoveSessionIDs(ids...)
	return _u
}

// RemoveSessions removes "sessions" edges to WebSession entities.
func (_u *UserUpdate) RemoveSessions(v ...*WebSession) *UserUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddSessions adds the "sessions" edges to the WebSession entity.
func (_u *UserUpdateOne) AddSessions(v ...*WebSession) *UserUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// RemoveSessions removes "sessions" edges to WebSession entities.
func (_u *UserUpdateOne) RemoveSessions(v ...*WebSession) *UserUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
